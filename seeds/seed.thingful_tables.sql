...
VALUES
 ...
 -- Replace our regular passwords with bcrypt digests
UPDATE thingful_users SET password='$2a$10$856F48Zw9.NI793QD0GPsOTVk2JOY/OiVH3oyQ.m.Zaqu4/SZxQ3e' WHERE password='bo-password';
UPDATE thingful_users SET password='$2a$10$0kL8hQGT4blpX0XO3S2NQelZVFfFf9a7c/HJGPbaq3Bx3q/3YSy4S' WHERE password='charlie-password';
UPDATE thingful_users SET password='$2a$10$zlYOKawyoPWwcHWMsCh/s.49tkAyxwE.nAgxQiiWLFdVgeHA8Nyt2' WHERE password='lex-password';
UPDATE thingful_users SET password='$2a$10$hjgA/pWQsRHjbp/AL2ztvOP8Kwt8V8c7aXHWH03a/Z03N0FCK3ubO' WHERE password='password';
UPDATE thingful_users SET password='$2a$10$Npv9QXwIN4KzGXSgU25nwOBoCRkNmuYh39SMRliB1Xw.PP/qgQv5q' WHERE password='sam-password';
UPDATE thingful_users SET password='$2a$10$uD3pYTMRPiNkxdcdPEsWpuKnLaICg0/NhnnSGvUSo.DW.znXiIpuS' WHERE password='ping-password';
